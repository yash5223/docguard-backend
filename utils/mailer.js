...
const OTP_COPY = {
  password_reset: {
    ...
    intro: 'Use the code below to reset your DocGuard account password. This code expires in 5 minutes.',
    textLabel: 'password reset code',
  },
  register: {
    subject: 'Verify your email for DocGuard',
    heading: 'Verify your email',
    intro: 'Use the code below to confirm this email address belongs to you and finish creating your DocGuard account. This code expires in 10 minutes.',
...
async function sendOtpEmail(toEmail, otpCode, purpose = 'password_reset') {
  ...
  const response = await fetch(BREVO_API_URL, {
    ...
    body: JSON.stringify({
      ...
      `,
      textContent: `Your DocGuard ${copy.textLabel} is: ${otpCode}`,
    }),
  });
  if (!response.ok) {
    let detail = '';
